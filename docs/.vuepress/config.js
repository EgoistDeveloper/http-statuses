...
const hostname = 'http-statuses.laravel-lang.com';

module.exports = {
    lang: 'en-US',
    title: 'Laravel Lang: HTTP Statuses',
    ...
    theme: defaultTheme({
        ...
        repo: 'https://github.com/Laravel-Lang/http-statuses',
        repoLabel: 'GitHub',
        docsRepo: 'https://github.com/Laravel-Lang/http-statuses',
        docsBranch: 'main',
        docsDir: 'docs',
        ...
        navbar: [
            ...
            { text: '3.x', link: '/changelog/3.x.md' }
        ],
